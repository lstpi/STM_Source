...
#ifdef ENABLE_EMU
#include "np2_runmon.h"

#define NRF_CE_HIGH()	{HAL_GPIO_WritePin(NRF_MODE_GPIO_PORT, NRF_MODE_PIN, 1); NP2_RUNMON_GPIOA(); HAL_Delay(10);}
#define NRF_CE_LOW()	{HAL_GPIO_WritePin(NRF_MODE_GPIO_PORT, NRF_MODE_PIN, 0); NP2_RUNMON_GPIOA(); HAL_Delay(10);}

#define NRF_CS_HIGH() 	{HAL_GPIO_WritePin(NRF_SPI_CS_GPIO_PORT, NRF_SPI_CS_PIN, 1); NP2_RUNMON_GPIOB(); HAL_Delay(50);}
#define NRF_CS_LOW() 	{HAL_GPIO_WritePin(NRF_SPI_CS_GPIO_PORT, NRF_SPI_CS_PIN, 0); NP2_RUNMON_GPIOB(); HAL_Delay(50);}
...
//Disable IRQ
#ifdef NRF_IRQ_DISABLE
#undef NRF_IRQ_ENABLE
#else

//#define NRF_IRQ_ENABLE	//Disable NRF IRQ
/* IRQ Pin */
/*#ifndef NRF_IRQ_PIN
#define NRF_IRQ_PIN		BRD_A3_PIN
#endif

#ifndef NRF_IRQ_GPIO_PORT
#define NRF_IRQ_GPIO_PORT 	BRD_A3_GPIO_PORT
#endif

#ifndef __NRF_IRQ_GPIO_CLK
#define __NRF_IRQ_GPIO_CLK 	__BRD_A3_GPIO_CLK()
#endif

#define NRF_IRQ_GET()	HAL_GPIO_ReadPin(NRF_IRQ_GPIO_PORT, NRF_IRQ_PIN)
*/
#endif
